  ...
  <div class="content">
    <hqit-content-page type="detail" :title="backTitle">
      <template slot="content">
        <el-form ref="entryForm" :model="entryForm" label-width="126px" :rules="entryRules">
          <el-row>
            <el-col :span="11" >
              <el-row style="margin-bottom:40px">
                ...
                <el-col :span="20" v-show="editData.respType == 3 || editData.respType == 4">
                  <ty-multi-text :label="'履职课程要求'" v-model="editData.courseRequire" :allowUpdate="!isCheck"
                ...
                <el-col :span="20" v-show="editData.respType == 3 || editData.respType == 4">
                  <ty-multi-text :label="'培训人员'" v-model="editData.trainee" :allowUpdate="!isCheck"
                  ...
                  <el-form-item label="学习时长："
                    ...
                    <div class="form-text">
                      <el-input size="medium"
                        oninput="value=value.replace(/[^\d]/g,'');if(value<1 || value > 999)value=1" class="iputNum"
                    ...
                    <div class="item-line1">
                      ...
                      <div class="item-text"
                        ...
                        <el-input size="medium" v-if="editData.issueType == 1" v-model="editData.performData"
                          type="number" oninput="value=value.replace(/[^\d]/g,'');if(value<1 || value>99)value=1">
                        </el-input>
                      ...
                      <div class="item-text"
                        ...
                        <el-input size="medium" min='1' v-model="editData.contentPeriodEx.month"
                          oninput="value=value.replace(/[^\d]/g,'');if(value<1 || value>12)value=1" class="iputNum"
                          type="number"></el-input>
                        <div style="margin-left:10px;margin-right:10px;">月</div>
                        <el-input size="medium" min='1' v-model="editData.contentPeriodEx.day"
                          oninput="value=value.replace(/[^\d]/g,'');if(value<1 || value>31 )value=1" class="iputNum"
                          type="number"></el-input>
            ...
            <el-col :span="11">
              <div class="">
                <el-col :span="20">
                  <ty-multi-text :label="'履职版本'" v-model="editData.keepName" :allowUpdate="isCheck"
                ...
                <el-col :span="20">
                  <ty-multi-text :label="'职责内容'" v-model="editData.content" :allowUpdate="!isCheck"
                ...
                <el-col :span="20">
                  <ty-multi-text :label="'职责标准'" :type="'textarea'" v-model="editData.standard" :allowUpdate="!isCheck"
                ...
                <el-col :span="20">
                  <ty-multi-text :label="'佐证材料要求'" v-model="editData.evidence" :allowUpdate="!isCheck"
