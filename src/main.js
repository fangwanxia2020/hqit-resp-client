...
if (process.env.NODE_ENV == "development") {
  Vue.prototype.$getFileUrl = (id)=>`${process.env.VUE_APP_BASE_API}/api/sysfile/file_info/download?id=${id}`
}else{
  Vue.prototype.$getFileUrl = (id)=>`${window.location.origin}${process.env.VUE_APP_BASE_API}/api/sysfile/file_info/download?id=${id}`
}
