...
export function login(data) {
  const {grant_type,client_id,client_secret,password,username,tenant}=data
  return selt.request({
    url: `auth/oauth/token?grant_type=${grant_type}&client_id=${client_id}&tenant=${tenant}&client_secret=${client_secret}&username=${username}&password=${password}`,
    method: 'post',
  })
}
